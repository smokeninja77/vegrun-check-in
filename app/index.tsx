...
function CheckInScreen() {
  ...
  const [searchBy, setSearchBy] = useState<
    "英文姓名 English Name" | "中文姓名 Chinese Name" | "手機號碼 Mobile Number"
  >("手機號碼 Mobile Number");
    ...
    <>
      ...
      <View style={{ padding: 20, backgroundColor: "transparent" }}>
        ...
        >
          ...
          <View style={{ alignItems: "center", justifyContent: "center", backgroundColor: "transparent", flex: 1 }}>
            <View style={{ alignItems: "center", justifyContent: "center", marginRight: 15 }}>
              ...
              >
                <Text style={{ marginBottom: 0, fontSize: 30, color: "#FF9800", fontWeight: "semi" }}>
                  {totalCheckIn}
                </Text>
            ...
            <View style={{ position: "absolute", bottom: 0, right: 0 }}>
              <Text style={{ marginTop: 5, fontStyle: "italic", fontWeight: 500 }}>
                {((totalCheckIn / data?.length) * 100).toFixed(1)}%
              </Text>
            </View>
          </View>
        </View>
        ...
        <View>
          ...
          />
          <TouchableOpacity
            style={{ position: "absolute", right: 0, top: 0, width: 55, height: 60 }}
            onPress={() => {
              setSearchValue("");
            }}
          >
        ...
        >
          <Text style={{ color: "white", textAlign: "center", fontWeight: "bold" }}>🔄 Refresh 更新</Text>
        </TouchableOpacity>
